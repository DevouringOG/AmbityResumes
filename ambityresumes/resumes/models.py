...
class Education(models.Model):
    applicant = models.ForeignKey(Applicant, related_name='educations', on_delete=models.CASCADE)
...
class Experience(models.Model):
    applicant = models.ForeignKey(Applicant, related_name='experiences', on_delete=models.CASCADE)
    area = models.ForeignKey('Area', on_delete=models.SET_NULL, null=True)
    company = models.CharField(max_length=255)
    start = models.DateField()
    end = models.DateField()
    industry = models.ForeignKey('ExperienceIndustry', on_delete=models.SET_NULL, null=True)
    position = models.ForeignKey('ExperiencePosition', on_delete=models.SET_NULL, null=True)
...
class Resume(models.Model):
    ...
    salary_currency = models.ForeignKey('Currency', on_delete=models.SET_NULL, null=True)
